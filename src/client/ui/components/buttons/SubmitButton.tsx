 ...
 * @example
 * ```tsx
 * const MyComponent = <SubmitButton testId="myTestId">MyComponent</SubmitButton>;
 * ```
 */
const SubmitButton = ({label, testId}: WithOptionalChildren<ComponentProps>) => (
    <Wrapper data-cy={testId} type="submit">{label}</Wrapper>
);

SubmitButton.displayName = 'SubmitButton';
SubmitButton.defaultProps = {testId: 'SubmitButton'};
